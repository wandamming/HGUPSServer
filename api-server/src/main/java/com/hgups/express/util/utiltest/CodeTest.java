...
//        t.outToImage();
        ...
        String dest = "D:/Download/hgups2.pdf";
        String dest3 = "D:/Download/hgups3.pdf";
        PDFUtilsTest.base64StringToPDF(base64Str, dest);
...
//            PDFUtils.setWaterPrint(bos, dest, "JFK Entry 1");
            ...
            String dest4src = PDFUtilsTest.getPDFBinary(new File(dest3));
            System.out.println("dest4src: " + dest4src);
            String dest4 = "D:/Download/hgups4.pdf";
            PDFUtilsTest.base64StringToPDF(dest4src, dest4);
