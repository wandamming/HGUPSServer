package com.hgups.express.business.ec.amazon;
...
public class AmazonUntil implements AmazonConstant {
    ...
    public static String urlEncode(String rawValue) {
        ...
        try {
            ...
            log.error("Unknown encoding: " + CHARACTER_ENCODING);
        }
            ...
            if (listOrdersResult != null) {
                ...
                if (orderLists != null) {
                    if (orderLists.size() == 1) {
                        orders.add(orderLists.get("OrderInfo"));
                    } else {
                        /***获取一个订单批次的所有订单内容*/
                        orders = (JSONArray) orderLists.get("OrderInfo");
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            log.error(" amazon error: " + String.valueOf(e));
        }
